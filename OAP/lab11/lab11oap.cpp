...
int  count_right(Tree* t);		// Подсчёт 
...
void main()
{
	...
	for (;;)
	{
		...
		cout << "5 - вывод дерева\n";
		cout << "6 - подсчет количества слов с буквой\n";
		cout << "7 - очистка дерева\n";
		cout << "8 - количество узлов правой ветви дерева\n";
		cout << "9 - выход\n";
		cout << "ваш выбор?\n";
		cin >> choice;
		cout << "\n";
		...
		case 8: numLeft = count_right(Root);
			cout << "Количество элементов правой ветви: " << numLeft << endl;
			break;
